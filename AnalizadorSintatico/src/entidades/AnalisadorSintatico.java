...
public class AnalisadorSintatico {
        ...
        if (t.getToken() == Token.TK_APR) {
            ...
            if (t.getToken() == Token.TK_FPR) {
                ...
                if (t.getToken() == Token.TK_PVIRG) {
                    ...
                    if (tokenAnterior.getLinha() != t.getLinha()) {
                        listaDeErros.add("Erro: Esperava-se ponto e vírgula na linha " + (t.getLinha() - 1) + "!");
                    } else {
                ...
                if (tokenAnterior.getLinha() != t.getLinha()) {
                    listaDeErros.add("Erro: Esperava-se um fecha pararentes reto na linha " + (t.getLinha() - 1) + ".");
                } else {
            ...
            if (t.getToken() == Token.TK_FP) {
                ...
                if (t.getToken() == Token.TK_PVIRG) {
                    ...
                    if (tokenAnterior.getLinha() != t.getLinha()) {
                        listaDeErros.add("Erro: Esperava-se ponto e vírgula ou { na linha " + (t.getLinha() - 1) + "!");
                    } else {
                ...
                if (tokenAnterior.getLinha() != t.getLinha()) {
                    listaDeErros.add("Erro: Esperava-se um fecha parentes na linha " + (t.getLinha() - 1) + ".");
                } else {
            ...
            if (tokenAnterior.getLinha() != t.getLinha()) {
                listaDeErros.add("Erro: Esperava-se [ ou ( ou ; ou = na linha " + (t.getLinha() - 1) + ".");
            } else {
    ...
    public void stmt_list1() {
        ...
        if (t.getToken() == Token.TK_ID || t.getLexema().equals("+") || t.getLexema().equals("-") || t.getLexema().equals("!")
                ...
                || t.getLexema().equals("printf") || t.getLexema().equals("scanf") || t.getLexema().equals("for")) {
            stmt();
            stmt_list1();
        }
    }
