...
public class FrmIndex extends javax.swing.JFrame {
    ...
    private void btnExecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExecutarActionPerformed
        ...
        try {
            ...
            AnalisadorSintatico analiserSintatico = new AnalisadorSintatico(path);
            res = analiserSintatico.program();
            
            long tempoFinal = System.currentTimeMillis();
            long tempoTotal = tempoFinal - tempoInicial; //tempo em millisegundo
            if (res.get(0).getListaDeErros().size() > 0) {
                String txt = "BUILD FAILED (total time: "+(tempoTotal/1000.0)+"\nseconds)", texto = "";
            ...
            txtAreaResult.setText("BUILD SUCCESSFUL \n(total time: "+(tempoTotal/1000.0)+"\nseconds)");
            ...
            JOptionPane.showMessageDialog(null, "Ocorreu algum erro no alisador." + e);
        }
